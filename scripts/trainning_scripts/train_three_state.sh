...
do
    out_model=../../model_data/${model}model_b10_e${e}_L0.0001_sMinMax_a${A}_c1_k${K}_ParaReLU_${np}PosKLoss_${wp}PosWeightLoss_hSplit_hv${hill_val}_v2
    out_folder=../../results/${model}model_b10_e${e}_L0.0001_sMinMax_a${A}_c1_k${K}_ParaReLU_${np}PosKLoss_${wp}PosWeightLoss_hSplit_hv${hill_val}_v2
    echo $out_model
