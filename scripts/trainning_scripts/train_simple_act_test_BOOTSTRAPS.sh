results_file="../../results/results_simple_bootstraps_leakyrelu.csv"
model=simple_act
e=200
wp=0.5
...
do 
    ...
    do
        ...
        out_folder=../../results/${model}model_b10_e${e}_L0.001_sMinMax_c1_k${K}_wp${wp}_LeakyReLU_hSplit_seed${seed}_weightInit_test_BOOTSTRAP_${i}
        echo $out_model
