...
results_file="../../results/results_simple_act_test_LeakyReLU.csv"
model=simple_act
e=200
wp=0.5
...
do for x in 0 31 76; do
    ...
    do
        out_model=../../model_data/${model}model_b10_e${e}_L0.001_sMinMax_c1_k${K}_wp${wp}_ParaReLU_hSplit_seed${adj_seed}_weightInit_test
        out_folder=../../results/${model}model_b10_e${e}_L0.001_sMinMax_c1_k${K}_wp${wp}_ParaReLU_hSplit_seed${adj_seed}_weightInit_test
        echo $out_model
